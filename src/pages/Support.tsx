...
const RESOURCES = [
  ...
  },
  {
    icon: Phone,
    title: "Disque 190",
    desc: "Polícia Militar — em situação de emergência imediata.",
    action: "tel:190",
    cta: "Ligar 190",
  },
  {
    ...
    desc: "Atendimento por mensagem do governo federal.",
    action: "https://wa.me/5561996101803",
    cta: "Abrir WhatsApp",
  },
  {
    icon: Scale,
    ...
    action: "https://www.gov.br/pt-br/servicos/orientacao-juridica-gratuita",
  ...
  },
  {
    ...
    action: "https://mpt.mp.br/pgt/atendimento-ao-cidadao",
